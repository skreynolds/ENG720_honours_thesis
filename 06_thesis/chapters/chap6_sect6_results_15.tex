\begin{table}[h]
	\centering
	\caption[Experiment 6 agent performance for +0.01pu step change at 15 sec mark]{Agent performance measurements for the expert learner experiment given a +0.01pu step disturbance to area 1 at the 15 sec mark.}\label{tab:6601_pos_15_sec_results}
	\begin{tabular}{rcrrrrr}
		...
		\midrule
		\csvreader[column count=24, late after line=\\]{./data/exp_06_res_15.csv}
		{
