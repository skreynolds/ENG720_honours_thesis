...
Identical experimental conditions to those used by Lillicrap \textit{et alias} were selected for the baseline experiment. The neural network architecture for actor and critic networks are shown in Table \ref{tab:4101}. 
