\begin{table}[h]
	\centering
	\caption{Agent performance measurements for the priority experience replay experiment given a +0.01pu step disturbance to area 1 at the 15 sec mark.}
	\begin{tabular}{rcrrrrr}
		...
		\midrule
		\csvreader[column count=24, late after line=\\]{./data/exp_xx_res_15.csv}
		{
