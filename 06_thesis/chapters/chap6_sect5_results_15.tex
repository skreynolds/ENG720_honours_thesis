\begin{table}[h]
	\centering
	\caption{Agent performance measurements for the priority experience replay experiment given a +0.01pu step disturbance to area 1 at the 15 sec mark.}\label{tab:6501_pos_15_sec_results}
