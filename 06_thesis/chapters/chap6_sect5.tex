...
\input{./chapters/chap6_sect5_results_a}

%------------------- Performance Results for Negative Test
\input{./chapters/chap6_sect5_results_b}

%------------------- Plots for a sample test
\begin{figure}[h]
	\centering
	
	\input{./figures/6602_frequency_response_1/frequency_response_1.tikz}
	\caption{text}
	
	\input{./figures/6603_control_signal_1/control_signal_1.tikz}
	\caption{text}
	
	\input{./figures/6604_frequency_response_2/frequency_response_2.tikz}
	\caption{text}
		
	\input{./figures/6605_control_signal_2/control_signal_2.tikz}
	\caption{text}
\end{figure}