\begin{table}[h]
	\centering
	\caption{Agent performance measurements for the activation function experiment given a +0.01pu step disturbance to area 1 at the 15 sec mark.}\label{tab:6301_pos_15_sec_results}
