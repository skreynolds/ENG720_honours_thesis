\begin{table}[h]
	\centering
	\caption[Experiment 3 agent performance for +0.01pu step change at 15 sec mark]{Agent performance measurements for the activation function experiment given a +0.01pu step disturbance to area 1 at the 15 sec mark.}\label{tab:6301_pos_15_sec_results}
	\begin{tabular}{rcrrrrr}
		...
		\midrule
		\csvreader[column count=24, late after line=\\]{./data/exp_03_res_15.csv}
		{
