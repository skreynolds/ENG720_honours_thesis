\begin{tikzpicture}
	\begin{axis}[
	    ylabel={time (sec)},
	    symbolic x coords={Baseline,, OU Noise,, Activation Function,, Priority Exp. Replay,, Stoch. Load Demand,, Expert Learner,, Neural Network},
	...
	\addplot [ybar, fill=green] coordinates {(Neural Network, 13.99)};
	...
	\addplot [ybar, fill=orange] coordinates {(Expert Learner, 13.64)};
	\addplot [ybar, fill=red] coordinates {(Stoch. Load Demand, 5.05)};
	...
	\node at (axis cs:Baseline,1.5){\textcolor{black}{N/A}};
	\node at (axis cs:OU Noise,1.5){\textcolor{black}{N/A}};
	\node at (axis cs:Activation Function,1.5){\textcolor{black}{N/A}};
	\node at (axis cs:Priority Exp. Replay,1.5){\textcolor{black}{N/A}};
