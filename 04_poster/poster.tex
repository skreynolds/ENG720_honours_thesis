...
\begin{block}{Results Comparison from Preliminary Experiments}
	\begin{minipage}{0.4\textwidth}
		\begin{figure}\scriptsize
			...
			\vspace{-1cm}
			\caption{ \ PI vs. DDPG frequency (Hz) for power area one over time (seconds).}
			\label{fig:f1}
		\end{figure}
		\vspace{-1.5cm}
		\begin{figure}\scriptsize
			...
			\vspace{-1cm}
			\caption{ \ PI vs. DDPG control signal for power area one over time (seconds).}
		\end{figure}
	\end{minipage}
	\hspace{6cm}
	\begin{minipage}{0.4\textwidth}
		\begin{figure}\scriptsize
			...
			\vspace{-1cm}
			\caption{ \ PI vs. DDPG frequency (Hz) for power area two over time (seconds).}
			\label{fig:f2}
		\end{figure}
		\vspace{-1.5cm}
		\begin{figure}\scriptsize
			...
			\vspace{-1cm}
			\caption{ \ PI vs. DDPG control signal for power area two over time (seconds).}
		\end{figure}
	\end{minipage}
