...
\begin{variableblock}{The Environment in the Frequency \& Temporal Domains}{fg=black,bg=dgreen!10}{fg=white,bg=green!20!gray}
	...
	\small
		\begin{align*}
			\dot{x}_2(t) &= \frac{1}{T_{sg_1}}\big( K_{sg_1} u_1(t) - x_2(t) \big) \\
			\dot{x}_3(t) &= \frac{1}{T_{t_1}} \big( K_{t_1} x_2(t) - x_3(t) \big) \\
			\dot{x}_4(t) &= \frac{1}{T_{gl_1}} \bigg( K_{gl_1} \big( x_3(t) - x_5(t) - \Delta p_{L1}(t) \big) - x_4(t) \bigg)
		\end{align*}
	\end{minipage}
	\hspace{0.5cm}
	\begin{minipage}{0.45\linewidth}
	\small
		\begin{align*}
			\boldsymbol{\dot{x}_2(t)} &= \frac{1}{T_{sg_1}}\big( K_{sg_1} u_1(t) - x_2(t) \big) \\
			\dot{x}_3(t) &= \frac{1}{T_{t_1}} \big( K_{t_1} x_2(t) - x_3(t) \big) \\
			\dot{x}_4(t) &= \frac{1}{T_{gl_1}} \bigg( K_{gl_1} \big( x_3(t) - x_5(t) - \Delta p_{L1}(t) \big) - x_4(t) \bigg)
		\end{align*}
	\end{minipage}
