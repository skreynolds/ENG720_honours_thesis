...
\begin{figure}[ht]
	\centering
	\resizebox{12cm}{!}{\input{./figures/205_multiple_area_power_system_overview/multiple_area_power_system_overview}}
...
\begin{figure}[h]
	\centering
	\resizebox{4.5cm}{!}{\input{./figures/205a_single_area_power_system_overview/single_area_power_system_overview}}
