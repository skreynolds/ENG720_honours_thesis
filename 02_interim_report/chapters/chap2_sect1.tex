...
\begin{figure}[ht]
	\centering
	\includegraphics[height=8cm]{205_multiple_area_system}
...
\begin{figure}[ht]
	\centering
	\includegraphics[height=3cm]{207_two_area_system}
