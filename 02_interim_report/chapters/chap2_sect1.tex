...
\begin{figure}[ht]
	\centering
	\resizebox{12cm}{!}{\input{./figures/205_multiple_area_power_system/multiple_area_power_system}}
...
\begin{figure}[ht]
	\centering
	\input{./figures/207_two_area_power_system_overview/two_area_power_system_overview}
