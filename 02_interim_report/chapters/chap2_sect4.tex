...
The update process uses a loss function, and gradient descent, along with backpropagation.

The other key innovation was the use of a second neural network, called the target network. The target network was a copy of the original neural network, updated periodically. 
