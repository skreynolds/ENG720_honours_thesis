\section{Temporal Domain Model for a Two Area Power System} \label{app:C1_power_system_ode}
...
\begin{figure}[h]
	\centering
	\resizebox{\textwidth}{!}{\input{./figures/C101_two_area_ode_derivation/two_area_ode_derivation}}
