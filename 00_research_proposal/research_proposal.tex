...
Achieving the desired research outcomes would see the following items addressed:
\begin{itemize}
	...
	\item investigating suitable software packages (open source or commercial) to develop power system simulation model;
	\item investigate suitable programming languages to implement DRL agent, and determine how this will be used in conjunction with the simulation environment;
	\item create a simulated model for the two area power system;
